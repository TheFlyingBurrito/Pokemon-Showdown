...
var commands = exports.commands = {
	...
	frontier: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('Parukia forum - Coming Soon! <br />' +
			'<b><font color="green">PARUKIAN BATTLE FRONTIER</font></b><br><br><b><font color="green">FRONTIER BRAINS</font></b><br><br>Ubers: XLR8R<br>OU: EricSaysHi<br>UU: The Flying Burrito<br>RU: Chinlar<br>NU: NU King Gary<br>Balanced Hackmons: Gamebrεaker<br><br>' +
			'<b><font color="green">BATTLE FRONTIER RULES</font></b><br>' +
			'-Goal of the Frontier League is to beat the 6 Frontier Brains and the Grand Frontier Brain.<br><br>-If a challenger loses to a Frontier Brain he cant challenge that frontier brain again till 24 hours after the match.He can still challenge other brains normally though<br><br>-Each Person has the right to Honor Challenge a Frontier Brain. Honor Challenge is a best out of 3 match at the ruleset of the Frontier Brain that is challenged. If the Challenger wins the honor challenge ( wins 2 out of 3 matches ) he replaces the curent Frontier Brain. If the Frontier Brain Wins ( wins 2 out of 3 matches ) he gets to keep his place as a Frontier Brain. A honor match must be first approved by leader of parukia ( Gary Oak ) . Each Challenger has the right of one honor challenge per week and no more.<br><br>-The First One that wins the Frontier League becomes the Grand Frontier Brain.<br><br>-Each time a Challenger beats the Frontier he becomes the new Grand Frontier Brain.<br><br>-When a Challenger beats a Frontier Brain he is given the Frontier Brains Badge as in symbol that he completed a challenge. Badges are non resetable and cannot be taken back.<br><br>-The Challenger can challenge the member of the Frontier League at any row possible.<br><br>-The Challenger has to beat the Grand Frontier Brain to take his place. The frontier is considered complete only when the Challenger defeats the Grand Frontier Brain<br><br>-The Challenger can challenge the Grand Frontier Brain only when he all 6 Frontier Badges<br><br>-If a Grand Frontier Brain loses from a Challenger he is no longer member of the Frontier . However he has the right to challenge it again as a Challenger this time.<br><br>-Frontier Brains have no right to challenge the Frontier except they lose a honor challenge since they are not considered as Frontier Brains anymore but as plain Challengers.<br><br>-Any Kind of dual account to trick the Frontier in order to get more places on the Frontier is going to get all your badges reset if you have any and if you are a Frontier Brain you are going to be removed from that place imidiatelly.<br><br>-After 21 days of complete inactivity a Frontier Brain is kicked out of his place and a new one is decided by a tournament of the tier he was<br><br>- Vacation status of a Frontier Brain is when he needs to go somewhere for a long time. Till he comes back a replacement is decided by a tournament of his tier. If Grand Frontier Brain is in vacation status and his replacement loses both him and his replacement are replaced by the challenger that beated the one replacing the Grand Frontier Brain.<br><br>-Rules Written by : The Flying Burrito<br>-Rules Approved by : Gary Oak (Current Owner Of Parukia)');
	},
