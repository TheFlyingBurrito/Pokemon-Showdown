...
var commands = exports.commands = {
	...
	announcements: function(target, room, user) {
		if (!this.canBroadcast()) return;
	...
	parukiafaq: function(target, room, user) {
		if (!this.canBroadcast()) return;
		return this.sendReplyBox('<center><font size=6>What is Parukia?</font><br><br>I am sure a lot of newcomers to this community will wonder "Well, what IS Parukia?" So, this FAQ was created to explain to everyone who doesnt already know, just WHAT Parukia is!<br><br>Parukia is a Pokemon Community with some very high goals in mind. For starters, our main goal is to become the greatest Pokemon Community in existence. If you think logically about this, by doing your best you have no limits - so if everyone at Parukia did their best to make Parukia a successful Pokemon community, there would be no limit to how successful we would become and eventually we WOULD be the best. This is where our first slogan came from: The very best, like no one ever was... or should I say, WORKING to be the very best, like no one ever was.<br><br>But we dont stop there with our high expectations. In concurrence with the above main goal of Parukia, we also have another goal in mind: That when we become a huge, successful and famous community, we will do what so far very few have been able to achieve: We will retain the air of a community built of friends like we have at the time I am writing this, no matter how large we become. We will also make this a 99.9% - 100% troll-free community. How do we plan to do this, you ask? Impossible, you might say? Think about this: The majority of the reason SOME - not all, but some - large communities are very unwelcoming and unfriendly to newcomers is because they have an influx of trolls and very few people there are really good friends with one another - I wont mention any names for the sake of keeping this positive, but I am sure a lot of you reading this can make an educated guess on some of the communities I am referring to. What we aim to do is to become good friends with everyone who becomes a part of Parukia, therefore keeping the aspect of a community of good friends with every new member that comes no matter how many there are, as well as achieving the goal of making newcomers feel at home and enjoy Parukia. Anyone who is labeled as a troll for his or her actions on the community is gone. Theres a fine line between trolling and joking around.<br><br>What do we have to offer? Good question! We have a main website, <a href="http://parukia.net">parukia.net</a>, which is constantly being updated on the latest PKMN news and information as well being updated several times a day with new guides and info on every single Pokemon game and Pokemon anime episode ever created; sometimes we have even beaten Serebii and PokeBeach to new information releases! These records were lost when we tore down our temporary main website on WordPress, but we shall certainly do it again! We have a bustling forum community with tons of discussions on almost every Pokemon subject around and a lot of non-Pokemon discussion forums too; it's very organized and extremely active and the Staff are very friendly! We have a Pokemon Showdown! server that is always active during the day with hilarious conversations and intense battles going on all the time, so feel free to check out any of these and contribute as you wish! As I said before, the Staff are very friendly; if you're somewhat scared of the higher-ups, be sure to check out our PS! server, as that is THE best way to get to know and befriend them - you'll see soon enough that we're nothing to be scared of and we're all fun guys and gals to hang out with! Finally, we have a large, active community of friendly and welcoming people who are willing to help you in a heartbeat with anything you need on Parukia; several members from Serebii and other communities have already come here and said "I feel so welcomed here compared to ___, where I feel as if I am not even needed there!" Everyone is needed on Parukia, whether you choose to believe it or not, our Staff and a large percentage of the community have a firm faith in that. It's sad how many people are amazed to be greeted with 6 or 7 welcomes in under 10 minutes, as other large communities and small ones too don't treat their new users like this, whether because they don't care or they aren't active enough to provide such a thing. But we do care about our members, and we're active enough to set extremely high goals like we have and be certain that we will soon accomplish them. We also have plans laid out and organization beyond belief for a community of our size; some users have even compared how we operate to how Smogon operates in terms of professionalism, organization and planning!<br><br>I hope this FAQ gives you a brief insight into what Parukia is all about. "The very best, like no one ever was..." That's our dream for Parukia. After reading this, I hope you will be inspired to join Parukia and help us with our mission too - it's a community effort, and without our community we wouldnt be the success we are today. Thanks to everyone for all your hard work you have put into Parukia, no matter how big or little, we definitely appreciate it all.</center>');
	},
