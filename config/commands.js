...
var commands = exports.commands = {
	...
	brain: function(target, room, user) {
		...
		if (target === ''){
			matched = true;
			this.sendReplyBox('<b><font color="green">FRONTIER BRAINS</font></b><br><br>Ubers: XLR8R<br>OU: EricSaysHi<br>UU: The Flying Burrito<br>RU: Chinlar<br>NU: NU King Gary<br>Balanced Hackmons: Gamebrεaker<br><br><b><font color="purple">Do /brain [name] such as /brain Chinlar to see their rules.</font>');
                }
		if (target === 'chinlar'){
			matched = true;
		...
		if (target === 'nu king gary'){
			matched = true;
			this.sendReplyBox('<b>NU King Gary</b><br><br><b>Tier: NU</b><br><br><img src="http://i.imgur.com/WsRxH6L.png"><br><br><b>Wins / Losses</b><br> 0 Wins - 0 Losses<br><br><b>Frontier Rules</b><br>- Electabuzz Banned<br>- Baton Pass Banned (Full and Quick Passing)');
		}
