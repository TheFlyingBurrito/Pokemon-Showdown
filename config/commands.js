...
var commands = exports.commands = {
	...
	frontier: function(target, room, user) {
		if (room.id === 'battlefrontier')  && if (!this.canBroadcast()) return this.sendReplyBox('<b><font color="green">PARUKIAN BATTLE FRONTIER</font></b><br><br>' +
		...
		if (!this.canBroadcast()) return;
		this.sendReply('This command can only be used in the Battle Frontier Room.');
	},
