...
var commands = exports.commands = {
	...
	leaders: function(target, room, user) {
		if (!this.canBroadcast()) return;
		return this.sendReplyBox('<b><font color="red">Champion</font></b><br>Azure<br><br><b><font color="red">Elite Four</font></b><br>Aura: FIRE<br>Frage: ROCK<br>Izanagi: FIGHTING<br>Oak: DRAGON<br><br><b><font color="red">Gym Leader</font></b><br>Vileman: GROUND<br>Windex: POISON<br>Chinlar: PSYCHIC<br>A07: FIRE<br>Raiykid: ELECTRIC<br>SA-X: DRAGON<br>lolsup: FLYING (Trainer-SaysHi)<br>Galaxy: WATER<br>Soul: NORMAL<br>Mayan: GRASS<br>Unknown: DARK<br>Nickk: ROCK<br>Sonix: ICE<br><br><b><font color="purple">Accepting new Gym Trainers, PM Aura Burst to sign up</font></b>');
	},
